      ...
      <div className="px-5 flex items-center h-screen md:px-16 lg:px-24">
        <div className="bg-white w-full rounded-lg shadow-md px-2 pt-12 pb-4 relative md:px-4 lg:px-10">
          ...
          <div className="max-h-[75vh] overflow-y-auto">
            <h2 className="text-start font-semibold text-2xl mb-3 xl:text-4xl">
              {name}
            </h2>
            <div className="md:flex gap-5 lg:gap-8 xl:gap-10">
              ...
              <div className="mt-12 md:mt-0 w-full">
                <div>
                  <h2 className="text-start font-semibold text-xl mb-2 xl:text-3xl">
                    Technology
                  </h2>
                  <div className="flex pl-5 gap-5 mt-3">
                    {technology.map((d, i) => (
                      <img src={d} alt="" key={i} className="h-6 xl:h-10" />
                    ))}
                  </div>
                ...
                <div className="mt-6">
                  <div className="flex items-center">
                    <h2 className="text-start font-semibold text-xl xl:text-3xl">
                      Year
                    </h2>
                    <p className="ml-5 mt-[3px] xl:text-xl xl:mt-[5px]">
                      {year}
                    </p>
                  </div>
                  <hr className="h-[1px] bg-green opacity-30 mt-6" />
                ...
                <div className="mt-6">
                  <div className="flex text-start">
                    <h2 className="font-semibold text-xl xl:text-3xl">Link</h2>
                    <a
                      href={link}
                      className="ml-5 mt-[3px] break-all xl:text-xl xl:mt-[5px]"
                      target="blank"
                    >
                      {link}
                    </a>
